...
export const ZIELBEREICH_2_LABELS: Record<string, string> = {
  basiskompetenzen_deutsch: "Erwerb von Basiskompetenzen: Deutsch",
  basiskompetenzen_mathe: "Erwerb von Basiskompetenzen: Mathematik",
  sozial_emotional_komp: "Erwerb sozial-emotionaler Kompetenzen",
  ausserschulische_koop: "Auf- und Ausbau außerschulischer Kooperationen",
  ...
  eltern_einbindung: "Lernförderliche Einbindung der Eltern",
  sozialraum: "Vernetzung in den Sozialraum",
  scp_weitere: "Weitere relevante schulische SCP-Schwerpunkte",
};

export const ZIELBEREICH_3_LABELS: Record<string, string> = {
  ib1_kompetenzen: "IB1: Fachliche und überfachliche Kompetenzen",
  ...
  ib3_werte_normen: "IB3: Werte- und Normenreflexion",
  ...
  ib3_gebaeude: "IB3: Gestaltung des Schulgebäudes und -geländes",
